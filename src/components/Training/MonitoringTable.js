...
import { Search, Filter, Download, CheckCircle, Clock, Eye } from 'lucide-react';
...
export default function MonitoringTable() {
    ...
    const getStatusBadge = (status) => {
        switch (status) {
            case 'completed':
                return <span style={{ color: '#16a34a', background: 'rgba(22, 163, 74, 0.1)', padding: '0.25rem 0.75rem', borderRadius: '99px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px', width: 'fit-content' }}><CheckCircle size={12} /> Completado</span>;
            case 'viewed':
                return <span style={{ color: '#ca8a04', background: 'rgba(202, 138, 4, 0.1)', padding: '0.25rem 0.75rem', borderRadius: '99px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px', width: 'fit-content' }}><Eye size={12} /> En Progreso</span>;
            default:
                return <span style={{ color: '#64748b', background: 'rgba(100, 116, 139, 0.1)', padding: '0.25rem 0.75rem', borderRadius: '99px', fontSize: '0.75rem', display: 'flex', alignItems: 'center', gap: '4px', width: 'fit-content' }}><Clock size={12} /> Pendiente</span>;
        }
    };
