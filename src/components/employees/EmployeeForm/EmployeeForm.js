...
export default function EmployeeForm({
    ...
    const trainingPlanDate = calculateTrainingPlanDate(formData.department, formData.area);

    // Wrap content based on embedded prop
    const formContent = (
        <div className={styles.formBody} style={embedded ? { padding: 0 } : {}}>
