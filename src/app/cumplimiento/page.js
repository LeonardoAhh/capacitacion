...
// Orden de clasificacin de estatus: pendientes primero, aprobados al final
...
export default function CumplimientoPage() {
    ...
    if (authLoading || !user) {
        return (
            <AdminLayout title="Cumplimiento Capacitacin">
    ...
    const downloadReport = () => {
        ...
        toast.success("xito", `Reporte de ${courseEmployees.length} empleados descargado`);
    };
...
<header>
  <div><div class="logo">Viaplastic  Capacitacin</div><div class="title">${selectedCourse}</div><div class="filterTag">${filterLabel}</div></div>
...
<table><thead><tr><th>ID</th><th>Nombre</th><th>Departamento</th><th>Puesto</th><th>Fecha</th><th>Calificacin</th><th>Estado</th></tr></thead>
<tbody>${rows}</tbody></table>
<footer>Documento Interno Capacitacin  ${now}</footer>
</body></html>`;
        ...
        <AdminLayout title="Cumplimiento Capacitacin">
            ...
            <div className={styles.container}>
                {loading ? (
                    ...
                    <>
                        {/* Course Selector & Actions (Unificado sin ttulo) */}
                                ...
                                <div className={styles.headerActions}>
                                    ...
                                    <div className={styles.filterWrapper}>
                                        <button
                                            ...
                                            title={exportFilter === 'all' ? 'Filtrar exportacin' : exportFilter === 'pending' ? 'Solo Pendientes' : 'Solo Aprobados'}
                                        >
                                            <Filter size={16} />
                                        </button>
                                        ...
                                        >
                                            ...
                                            <div className={styles.employeeDetails}>
                                                <div className={styles.detailGrid}>
                                                    ...
                                                    <div className={styles.detailItem}>
                                                        <span className={styles.detailLabel}>Calificacin</span>
                            ...
                            {totalPages > 1 && (
                                <div className={styles.pagination}>
                                    ...
                                    <div className={styles.pageButtons}>
                                        ...
                                        <span className={styles.pageNum}>Pgina {currentPage} de {totalPages}</span>
                                        <Button
                                            variant="outline"
                                            size="sm"
