            ...
            <div className={styles.profileCard}>
              ...
              <div className={styles.profileRows}>
                <div className={styles.profileRow}>
                  <span className={styles.profileRowLabel}>Depto.</span>
  ...
  return (
    <section className={styles.card} aria-label="Gestión del Mural de Reconocimiento">
      ...
      <div className={styles.complianceAdminPanel}>
        <div className={styles.complianceTopRow}>
          <div className={styles.complianceTopInfo}>
            <p className={styles.complianceAdminTitle}>Cumplimiento de Capacitación</p>
            <p className={styles.complianceAdminDesc}>WhatsApp y fechas visibles en el mural.</p>
          </div>
          <div className={`${styles.fieldGroup} ${styles.complianceWhatsappField}`}>
            <label className={styles.fieldLabel}><Phone size={13} /> WhatsApp</label>
            <input
              type="tel"
              className={styles.fieldInput}
          ...
          <button type="button" className={styles.muralSaveBtn} onClick={saveCompliance} title="Guardar" aria-label="Guardar cumplimiento">
            <Save size={14} />
          </button>
        </div>
        <div className={styles.complianceDatesSection}>
          ...
          {complianceConfig.complianceExamDates.map((item, idx) => (
            <div key={idx} className={styles.complianceDateRow}>
              <input
                type="text"
                className={`${styles.fieldInput} ${styles.complianceDateLabel}`}
                value={item.label}
                onChange={(e) => updateExamDate(idx, 'label', e.target.value)}
                placeholder="Ej. 2o. Período 2026"
              />
